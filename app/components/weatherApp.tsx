    ...
    <div>
      <div className="grid grid-rows-3 grid-cols-6">
        <div className="grid col-span-full grid-cols-3 justify-items-center mt-20">
            <h1 className="col-start-1 col-end-1 text-2xl/7 font-bold text-blacl sm:truncate sm:text-3xl sm:tracking-tight">
              Meteo Voyage
            </h1>
        ...
        <div className="col-start-5 col-end-9">{!!cityUser && <ViewWeather name={cityUser} />}</div>
      </div>
      </div>
